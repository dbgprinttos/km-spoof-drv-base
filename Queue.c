...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, joonydriverQueueInitialize)
#endif

NTSTATUS
joonydriverQueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = joonydriverEvtIoDeviceControl;
    queueConfig.EvtIoStop = joonydriverEvtIoStop;
